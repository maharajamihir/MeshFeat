...
from other_methods.mesh import get_k_eigenfunc_vec_vals, load_first_k_eigenfunctions
from util.utils import load_preprocessed_data
...
def create_ray_dataloader(preproc_data_path,
    ...
    data = load_preprocessed_data(os.path.join(preproc_data_path))
