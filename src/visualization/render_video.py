...
import numpy as np
import torch
from util.cameras import cam_resize, load_extr_and_intr_camera, cam_crop
from util.utils import load_config
from visualization.renderer import make_renderer_with_trained_model
...
if __name__ == "__main__":
    ...
    out_dir = os.path.join(config["data"]["render_img_directory"], config["experiment"]["split"])
    image_folder = join(out_dir, "images", folder_name+"_"+args.resolution)
